...
class Backflow:
    ...
    def Be(self, r1, r2, r3, r4):
        """Be backflow"""
        rI = ([0, 0, 0])
        r1_bf = r1 + self.ALL(r1, r2, rI, 0, 0, 0) + self.ALL(r1, r3, rI, 0, 1, 0) + self.ALL(r1, r4, rI, 0, 1, 0)
        r2_bf = r2 + self.ALL(r2, r1, rI, 0, 0, 0) + self.ALL(r2, r3, rI, 0, 1, 0) + self.ALL(r2, r4, rI, 0, 1, 0)
        r3_bf = r3 + self.ALL(r3, r1, rI, 1, 0, 0) + self.ALL(r3, r2, rI, 1, 0, 0) + self.ALL(r3, r4, rI, 1, 1, 0)
        r4_bf = r4 + self.ALL(r4, r1, rI, 1, 0, 0) + self.ALL(r4, r2, rI, 1, 0, 0) + self.ALL(r4, r4, rI, 1, 1, 0)
        return r1_bf, r2_bf, r3_bf, r4_bf
