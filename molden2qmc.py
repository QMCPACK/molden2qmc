...
"""
    ...
    def fit(self, fit_function, xdata, ydata, p0):
...
def main():
    ...
    parser.add_argument('output_file', type=str, default='stowfn.data', nargs='?', help="path to output file")
    ...
    if args.code == 0:
        ...
        Orca(input_file, args.pseudoatoms).stowfn(args.output_file)
    elif args.code == 4:
